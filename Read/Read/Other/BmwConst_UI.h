...
#ifndef BmwConst_UI_h
#define BmwConst_UI_h
...
#define BmwColor(r, g, b, a)             [UIColor colorWithRed:(r)/255.0f green:(g)/255.0f blue:(b)/255.0f alpha:a]
#define BmwHexColor(String)              [BmwSystemManager colorWithHexString:String]
#define BmwWeakSelf(type)                __weak typeof(type) weak##type = type;
#define BmwDocumentDirectory             [(NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)) lastObject]
