...
-(UIView *)theme1
{
    if (!_theme1) {
        ...
        _theme1.backgroundColor = Color(248, 218, 138,1.0);
...
-(UIView *)theme2
{
    if (!_theme2) {
        ...
        _theme2.backgroundColor = Color(188, 178, 190,1.0);
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ThemeNotification" object:tap.view.backgroundColor];
}
-(void)layoutSubviews
{
